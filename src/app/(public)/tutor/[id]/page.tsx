...
export default function PublicTutorProfilePage() {
  ...
  const handleFavorite = () => {
    // Prompt to sign up for favorites feature
    const returnUrl = `/tutor/${tutor?.id}`;
    router.push(
      `/signup?returnUrl=${encodeURIComponent(returnUrl)}&feature=favorites`
    );
  };
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <h3 className="font-medium text-gray-900">
                          Muốn liên hệ với gia sư?
                        </h3>
                        <p className="text-sm text-gray-600">
                          Đăng ký miễn phí để gửi yêu cầu dạy học
                        </p>
                      </div>
                      <Button
                        onClick={handleSignUpToContact}
                ...
                <Card className="bg-blue-50 border-blue-200 mt-6">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Đăng ký để đặt lịch học với gia sư
                    </p>
                    <Button size="sm" onClick={handleSignUpToContact}>
                      Đăng ký ngay
                    </Button>
                  </CardContent>
                </Card>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <h3 className="text-xl font-semibold mb-2">
                    Đăng ký để xem đánh giá
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Xem đánh giá chi tiết từ các học sinh khác
                  </p>
                  <Button onClick={handleSignUpToContact}>Đăng ký ngay</Button>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
